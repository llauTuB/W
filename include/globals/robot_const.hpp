...
constexpr auto INTAKE_UPSCORE_TOGGLE = pros::E_CONTROLLER_DIGITAL_R1;
...
constexpr auto DOUBLE_PARK_TOGGLE = pros::E_CONTROLLER_DIGITAL_B;
constexpr auto DESCORE_TOGGLE = pros::E_CONTROLLER_DIGITAL_DOWN;

constexpr auto FILTER_TOGGLE = pros::E_CONTROLLER_DIGITAL_UP;
constexpr auto FLIP_IMU_TOGGLE = pros::E_CONTROLLER_DIGITAL_X;

// Drivetrain constants
constexpr auto TRACK_WIDTH = 11.5;
...
constexpr auto HORIZONTAL_OFFSET = -4;